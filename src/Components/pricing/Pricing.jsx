...
const Pricing = () => {
  return (
    <section className="pricing container section"> <h2 className="section__title">Pricing Plans</h2>
      <div className="pricing__container grid">
        ...
        <div className="pricing__item best">
          ...
          <p className="pricing__title">Unlimited product including app intregation and more features</p>
        ...
        <div className="pricing__item">
          ...
          <p className="pricing__title">A large option for large companies and individuales</p>
